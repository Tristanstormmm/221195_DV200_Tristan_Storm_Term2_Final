                    ...
                    <div class="profile-card">
                        ...
                        <?php else: ?>
                            ...
                            <div style="margin-left: auto;">
                                <a href="index.php">
                                    <button
                                        style="background-color: red; display: inline-block; padding: 10px 20px; color: white; border-radius: 5px; border: none; text-decoration: none; font-weight: medium; font-size: 16px; margin-right: 50px;">Logout</button>
                                </a>
                            </div>
                        <?php endif; ?>
                    </div>
                        ...
                        <?php if ($numAppointments > 0) { ?>
                            <?php while ($row = mysqli_fetch_assoc($appointmentsResult)) { ?>
                                <div class="appointment-block"
                                    ...
                                    <a href="edit_appointment.php?id=<?php echo $row['id']; ?>"><button
                                            style="font-size: 16px; display: inline-block; padding: 10px 20px; margin-top: 20px; background-color: #089FA6; color: white; border-radius: 5px; text-decoration: none; font-weight: medium;">Edit</button></a>
                                    <a href="delete_appointment.php?id=<?php echo $row['id']; ?>"><button
                                            style="font-size: 16px; display: inline-block; padding: 10px 20px; margin-top: 20px; color: white; border-radius: 5px; text-decoration: none; font-weight: medium;">Delete</button></a>
                                </div>
                            ...
                            <div class="appointment-block"
                                ...
                                <form method="POST" action="">
                                    ...
                                    <button type="submit" name="add_appointment"
                                        style="display: inline-block; padding: 10px 20px; margin-top: 20px; background-color: #089FA6; color: white; border-radius: 5px; text-decoration: none; font-weight: medium;">Add</button>
                                </form>
                            </div>
                        </div>
                    </div>
